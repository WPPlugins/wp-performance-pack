...
/*
	Copyright 2014-2017 Björn Ahrens (email : bjoern@ahrens.net) 
...
abstract class WPPP_Module {
	...
	public function get_default_options() { 
		$res = array();
		foreach ( static::$options_default as $option => $opt )
			$res[ $option ] = $opt[ 'default' ];
		return $res;
	}
	...
	public function validate_options ( &$input, $output ) {
		foreach ( static::$options_default as $optname => $opt ) {
